...
BUILD		:=	build
SOURCES		:=	source ../debugfont_renderer/source ../bitmap_font
DATA		:=	data
SHADERS		:=	shaders ../debugfont_renderer/shaders ../bitmap_font
INCLUDES	:=	include ../debugfont_renderer/include ../bitmap_font

TITLE		:=	MAPI Test - PSL1GHT
APPID		:=	MAPI0003
